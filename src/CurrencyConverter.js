            ...
            <div className="container-xxl">
              <div className="row ms-1 me-1 shadow-lg p-3 bg-body border-top border-1 border-dark" id="split-content">
                ...
                <div className='col-lg-1 mt-4'>
                  <button className="form-control exchange-button" onClick={this.handleSwapValuesChangeData}>
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" height="2em" viewBox="0 0 512 512" className="desktopIcon" xmlns="http://www.w3.org/2000/svg">
                      <path fill="none" strokeLinecap="square" strokeMiterlimit="10" strokeWidth="32" d="M304 48l112 112-112 112m94.87-112H96m112 304L96 352l112-112m-94 112h302">
                      </path>
                    </svg>
                  </button>
                </div>
