              ...
              <div id="navbarNav">
                <ul className="navbar-nav">
                  <li className="nav-item" onClick={this.handleClick}>
                    <Link className="nav-link" aria-current="page" id="navbar-text" to="/CurrencyConverter">
                      <h5 id="title-color" className={`${this.state.flag ? 'focus-item' : ''}`}>Currency Converter
                      </h5>
                    </Link>
                  </li>
                  <li className="nav-item" onClick={this.handleClickExchange}>
                    <Link className="nav-link" aria-current="page" id="navbar-text" to="/ExchangeRate">
                      <h5 id="title-color" className={`${this.state.flag ? '' : 'focus-item'}`}>Exchange Rate
                      </h5>
                    </Link>
                  </li>
                </ul>
